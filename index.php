    ...
    <div class="row m-0">
      <div class="col-lg-6 col-md-6">
        <div class="cd">
          ...
          <form method="POST" action="register.php" class="form-area">
              <div class="mb-3">
              ...
              <input type="submit" class="btn btn-info" value="Sign In" name="signIn" style="width: 200px; margin-top: 10px;margin-left: 130px;">

        </form>

        <div class="links">
                <p>Don't have an account yet?</p>
                <button onclick="window.location.href='acc.php#about'" style="border: none; outline: none;background: none;" class="text-primary">Register</button>
              </div>
        </div>
      </div>
      <div class="col-12 col-xl-6 p-5">
